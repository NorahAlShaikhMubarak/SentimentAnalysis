...
using Sentiment AnalysisML.Model.DataModels;
using Microsoft.ML.Trainers;

namespace Sentiment AnalysisML.ConsoleApp
{
    public static class ModelBuilder
{
    private static string TRAIN_DATA_FILEPATH = @"G:\Downloads\wikiDetoxAnnotated40kRows.tsv";
